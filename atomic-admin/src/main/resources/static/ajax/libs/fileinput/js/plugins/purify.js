...
var MUSTACHE_EXPR = /\{\{[\s\S]*|[\s\S]*\}\}/gm; // Specify templates detection regex for SAFE_FOR_TEMPLATES mode
...
function createDOMPurify() {
  ...
  // a new empty registry is used when creating a templates contents owner
  ...
  /* Output should be safe for common templates engines.
  ...
  var _sanitizeElements = function _sanitizeElements(currentNode) {
    ...
    /* Sanitize element content to be templates-safe */
  ...
  var _isValidAttribute = function _isValidAttribute(lcTag, lcName, value) {
    ...
    /* Sanitize attribute content to be templates-safe */
    if (SAFE_FOR_TEMPLATES) {
