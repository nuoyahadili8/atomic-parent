package com.atomic.framework.aspectj;
...
import com.atomic.common.enums.BusinessStatus;
import com.atomic.common.json.JSON;
...
import com.atomic.system.domain.SysOperLog;
...
public class LogAspect {
     ...
     * 配置织入点
      */
    @Pointcut("@annotation(com.atomic.common.annotation.Log)")
