...
function(window) {
  ...
  JTopo = {
    ...
    MouseCursor: {
      ...
      move: "move"
      // open_hand: "url(../static/styles/images/design/cur/openhand.cur) 8 8, default",
      // closed_hand: "url(../static/styles/images/design/cur/closedhand.cur) 8 8, default"
    },
...
function(JTopo) {
  ...
  function toJson(a) {
    ...
    c = "text,elementType,x,y,width,height,visible,alpha,rotate,scaleX,scaleY,fillColor,shadow,transformAble,zIndex,dragable,selected,showSelected,font,fontColor,textPosition,textOffsetX,textOffsetY,tipText,tipPosition,tipFont,tipFontColor".split(","),
    d = "{";
    d += "frames:" + a.frames,
    d += ", scenes:[";
...
function(a) {
  ...
  function c(c) {
    ...
    function eee(a) {
        ...
        this.dragEnter = !0;
        var b = d(a);
        n.dispatchEventToScenes("dragenter", b),
        n.dispatchEvent("dragenter", b)
      }
     function fff(a) {
        p = setTimeout(function() {
          o = !0
        ...
        var b = d(a);
        n.dispatchEventToScenes("dragleave", b),
        n.dispatchEvent("dragleave", b),
        n.needRepaint = 0 == n.animate ? !1 : !0
      }
     function hhh(a) {
         var b = d(a);
         n.dispatchEventToScenes("drop", b),
         n.dispatchEvent("drop", b),
         n.needRepaint = 0 == n.animate ? !1 : !0
       }
     function iii(a) {
         ...
         o = !1;
         var b = d(a);
         (n.dispatchEventToScenes("dragover", b), n.dispatchEvent("dragover", b))
       }
    function g(a) {
      var b = d(a);
      n.mouseDown = !0,
    ...
    function m(b) {
      a.util.isIE || !window.addEventListener ? (b.ondrop = hhh,b.ondragenter = eee, b.ondragleave = fff,b.ondragover = iii,b.onmouseout = f, b.onmouseover = e, b.onmousedown = g, b.onmouseup = h, b.onmousemove = i, b.onclick = j, b.ondblclick = k, b.onmousewheel = l, b.touchstart = g, b.touchmove = i, b.touchend = h) : (b.addEventListener("drop", hhh),b.addEventListener("dragover", iii),b.addEventListener("dragenter", eee),b.addEventListener("dragleave", fff),b.addEventListener("mouseout", f), b.addEventListener("mouseover", e), b.addEventListener("mousedown", g), b.addEventListener("mouseup", h), b.addEventListener("mousemove", i), b.addEventListener("click", j), b.addEventListener("dblclick", k), a.util.isFirefox ? b.addEventListener("DOMMouseScroll", l) : b.addEventListener("mousewheel", l)),
    ...
    var q = "click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,drop,dragenter,dragleave,dragover,mousewheel,touchstart,touchmove,touchend,keydown,keyup".split(","),
    r = this;
...
function(a) {
  function b(c) {
    ...
    this.paintChilds = function(b) {
      for (var c = 0; c < this.zIndexArray.length; c++) for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f < e.length; f++) {
        ...
        if (1 == this.paintAll || this.isVisiable(g)) {
          ...
          g instanceof a.InteractiveElement && (g.selected && 1 == g.showSelected && g.paintSelected(b), (1 == g.isMouseOver|| 1 == g.isDragEnter) && g.paintMouseover(b)),
          g.paint(b),
          b.restore()
        }
      }
    ...
    this.dropHandler = function(b) {
      this.stage.cursor != a.MouseCursor.normal && (this.stage.cursor = a.MouseCursor.normal),
      e.clearOperations();
      var c = this.toSceneEvent(b);
      this.selectElement(c);
      null != this.currentElement && (c.target = e.currentElement, this.currentElement.dropHandler(c)),
      this.dispatchEvent("drop", c),
      this.mouseDown = !1
      },
    ...
    this.mousemoveHandler = function(b) {
      ...
      if(null != d){
    	  if(e.mouseOverelement && e.mouseOverelement !== d && (c.target = d, e.mouseOverelement.mouseoutHandler(c)), e.mouseOverelement = d, 0 == d.isMouseOver) {
    ...
    this.dragoverHandler = function(b) {
  	  this.mousecoord = {
        x: b.x,
        y: b.y
      };
      ...
      var d = e.getElementByXY(c.x, c.y);
      if(null != d){
    	  if(e.dragEnterelement && e.dragEnterelement !== d && (c.target = d, e.dragEnterelement.dragenterHandler(c)), e.dragEnterelement = d, 0 == d.isDragEnter) {
    		  c.target = d, d.dragenterHandler(c), e.dispatchEvent("dragenter", c);
    	  }else{
    		  c.target = d, d.dragoverHandler(c), e.dispatchEvent("dragover", c);
    	  }
      }else{
    	  if(e.dragEnterelement){
    		  c.target = d, e.dragEnterelement.dragleaveHandler(c), e.dragEnterelement = null, e.dispatchEvent("dragleave", c);
    	  } else{
    		  c.target = null, e.dispatchEvent("dragover", c);
    	  }
      }
    },
    ...
    this.mouseoutHandler = function(a) {
     ...
     this.dragenterHandler = function(a) {
          var b = this.toSceneEvent(a);
          this.dispatchEvent("dragenter", b)
        },
    this.dragleaveHandler = function(a) {
        var b = this.toSceneEvent(a);
        this.dispatchEvent("dragleave", b)
      },
    ...
    var f = "click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,drop,dragover,dragenter,dragleave,mousewheel,touchstart,touchmove,touchend,keydown,keyup".split(","),
    g = this;
...
function(a) {
  ...
  function c() {
    this.initialize = function() {
      ...
      this.isMouseOver = !1;
      this.isDragEnter = !1;
      var a = "dragable,selected,showSelected,isMouseOver,isDragEnter".split(",");
      this.serializedProperties = this.serializedProperties.concat(a)
    },
    this.initialize(),
    ...
    this.dropHandler = function(a) {
       this.isDragEnter = !1,
        this.dispatchEvent("drop", a)
      },
    this.mouseoverHandler = function(a) {
      this.isMouseOver = !0,
    ...
    this.dragenterHandler = function(a) {
        this.isDragEnter = !0,
        this.dispatchEvent("dragenter", a)
     },
    this.dragoverHandler = function(a) {
        this.dispatchEvent("dragover", a)
     },
    this.dragleaveHandler = function(a) {
        this.isDragEnter = !1,
        this.dispatchEvent("dragleave", a)
     },
    ...
    var b = "click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,drop,dragover,dragleave,dragenter,touchstart,touchmove,touchend".split(","),
    d = this;
  ...
  function d() {
    ...
    this.isInBound = function(a, c) {
      if (this.selectedPoint = null, 1 == this.editAble) for (var e = 0; e < b.length; e++) {
        ...
        if (a > f.left && a < f.right && c > f.top && c < f.bottom) return this.selectedPoint = b[e],
        !0
      }
...
function(a) {
  function b(c) {
    this.initialize = function(c) {
      ...
      this.tipText = "",
      this.tipPosition = "Top_Center",
      this.tipFont = "12px Consolas",
      this.tipFontColor = "255,0,0",
      this.textOffsetX = 0,
      this.textOffsetY = 0,
      this.transformAble = !0,
      this.inLinks = null,
      this.outLinks = null;
      var d = "text,font,fontColor,textPosition,textOffsetX,textOffsetY,borderRadius,tipText,tipPosition,tipFont,tipFontColor".split(",");
    ...
    this.paintText = function(a) {
      ...
      if (null != bb && "" != bb) {
        a.beginPath(),
        a.font = this.tipFont;
        var c = a.measureText(bb).width,
        d = a.measureText("田").width;
        a.fillStyle = "rgba(" + this.tipFontColor + ", " + this.alpha + ")";
        var e = this.getTextPostion(this.tipPosition, c, d);
        a.fillText(bb, e.x, e.y),
        a.closePath()
      }
    },
  ...
  function e(a, b, c) {
    ...
    this.paint = function(a) {
      ...
      a.fillText(this.text, -this.width / 2, this.height / 2),
      (this.isMouseOver||this.isDragEnter) && (a.moveTo( - this.width / 2, this.height), a.lineTo(this.width / 2, this.height), a.stroke()),
      a.closePath(),
      this.paintBorder(a),
      this.paintCtrl(a),
      this.paintAlarmText(a)
...
function(a) {
  ...
  function f(b, c, g) {
    ...
    this.getStartPosition = function() {
      var a;
      return null != this.arrowsRadius && (a = h(this.nodeA, this.nodeZ)),
      null == a && (a = {
        x: this.nodeA.cx,
        y: this.nodeA.cy
      }),
...
function(a) {
  ...
  function j(a, b) {
    function c(b, e) {
      ...
      d[e].nodes.push(b),
      d[e].childs.push(f);
      for (var g = 0; g < f.length; g++) c(f[g], e + 1),
      f[g].parent = b
    }
    var d = [];
    return c(b, 0),
...
function(a) {
  ...
  var e = "click,mousedown,mouseup,mouseover,mouseout,mousedrag,drop,dragenter,dragover,dragleave,keydown,keyup".split(",");
