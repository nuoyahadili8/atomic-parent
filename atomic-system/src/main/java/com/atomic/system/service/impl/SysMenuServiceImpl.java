...
import com.atomic.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
     ...
     */
    @Override
    public List<SysMenu> selectMenusByUser(SysUser user, int parentId) {
     ...
     */
    @Override
    public List<SysMenu> selectSystemMenuByUser(SysUser user) {
        List<SysMenu> menus = new ArrayList<>();
        // 管理员显示所有菜单信息
        if (user.isAdmin()) {
            menus = menuMapper.selectSystemMenuAll();
        } else {
            menus = menuMapper.selectSystemMenuByUserId(user.getUserId());
        }
        return menus;
    }
